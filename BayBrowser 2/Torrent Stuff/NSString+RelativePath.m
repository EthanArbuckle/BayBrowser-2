...
{
    return [self relativePathFromBaseDirPath:[(Controller *)[Delegate torrentController] documentsDirectory]];
}

- (NSString *)absolutePathFromDocumentDirectory
{
    return [self absolutePathFromBaseDirPath:[(Controller *)[Delegate torrentController] documentsDirectory]];
}
