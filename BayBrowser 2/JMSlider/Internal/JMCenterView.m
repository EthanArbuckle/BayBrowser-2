...
- (void)drawButtonInRect:(CGRect)rect;
{
    ...
    if (!activityView_)
    {
        ...
        [self.title drawInRect:CGRectOffset(rect, 0, kJMButtonPadding.height -1.) withFont:kJMButtonFont lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentCenter];
    }
}
